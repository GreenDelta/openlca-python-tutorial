...
The script below explains how to create a product system, and shows how to calculate, export LCIA results as csv, and delete it again finally. For selecting the reference process and the LCIA method, a dialogue pops up. 
